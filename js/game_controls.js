function placeBsBtn() {
	...
	$("#import-1_wrapper #import").remove();
...
[
  "CUSTOMSETDEX_RB","CUSTOMSETDEX_Y","CUSTOMSETDEX_GS","CUSTOMSETDEX_C","CUSTOMSETDEX_RS",
  "CUSTOMSETDEX_RSFR","CUSTOMSETDEX_RSIT","CUSTOMSETDEX_RSDE","CUSTOMSETDEX_RSES","CUSTOMSETDEX_RSJA",
  "CUSTOMSETDEX_E","CUSTOMSETDEX_EFR","CUSTOMSETDEX_EIT","CUSTOMSETDEX_EDE","CUSTOMSETDEX_EES","CUSTOMSETDEX_EJA",
  "CUSTOMSETDEX_FRLG","CUSTOMSETDEX_FRLGDE","CUSTOMSETDEX_FRLGES","CUSTOMSETDEX_FRLGJA",
  "CUSTOMSETDEX_DP","CUSTOMSETDEX_Pl","CUSTOMSETDEX_HGSS",
  "CUSTOMSETDEX_BW","CUSTOMSETDEX_B2W2","CUSTOMSETDEX_B2W2HC",
  "CUSTOMSETDEX_XY","CUSTOMSETDEX_ORAS",
...
function updateDex(customsets) {
	for (var pokemon in customsets) {
		for (var moveset in customsets[pokemon]) {
			...
			if (!CUSTOMSETDEX_RSFR[pokemon]) CUSTOMSETDEX_RSFR[pokemon] = {};
			CUSTOMSETDEX_RSFR[pokemon][moveset] = customsets[pokemon][moveset];
			if (!CUSTOMSETDEX_RSIT[pokemon]) CUSTOMSETDEX_RSIT[pokemon] = {};
			CUSTOMSETDEX_RSIT[pokemon][moveset] = customsets[pokemon][moveset];
			if (!CUSTOMSETDEX_RSDE[pokemon]) CUSTOMSETDEX_RSDE[pokemon] = {};
			CUSTOMSETDEX_RSDE[pokemon][moveset] = customsets[pokemon][moveset];
			if (!CUSTOMSETDEX_RSES[pokemon]) CUSTOMSETDEX_RSES[pokemon] = {};
			CUSTOMSETDEX_RSES[pokemon][moveset] = customsets[pokemon][moveset];
			if (!CUSTOMSETDEX_RSJA[pokemon]) CUSTOMSETDEX_RSJA[pokemon] = {};
			CUSTOMSETDEX_RSJA[pokemon][moveset] = customsets[pokemon][moveset];
			if (!CUSTOMSETDEX_E[pokemon]) CUSTOMSETDEX_E[pokemon] = {};
			CUSTOMSETDEX_E[pokemon][moveset] = customsets[pokemon][moveset];
			if (!CUSTOMSETDEX_EFR[pokemon]) CUSTOMSETDEX_EFR[pokemon] = {};
			CUSTOMSETDEX_EFR[pokemon][moveset] = customsets[pokemon][moveset];
			if (!CUSTOMSETDEX_EIT[pokemon]) CUSTOMSETDEX_EIT[pokemon] = {};
			CUSTOMSETDEX_EIT[pokemon][moveset] = customsets[pokemon][moveset];
			if (!CUSTOMSETDEX_EDE[pokemon]) CUSTOMSETDEX_EDE[pokemon] = {};
			CUSTOMSETDEX_EDE[pokemon][moveset] = customsets[pokemon][moveset];
			if (!CUSTOMSETDEX_EES[pokemon]) CUSTOMSETDEX_EES[pokemon] = {};
			CUSTOMSETDEX_EES[pokemon][moveset] = customsets[pokemon][moveset];
			if (!CUSTOMSETDEX_EJA[pokemon]) CUSTOMSETDEX_EJA[pokemon] = {};
			CUSTOMSETDEX_EJA[pokemon][moveset] = customsets[pokemon][moveset];
			if (!CUSTOMSETDEX_FRLG[pokemon]) CUSTOMSETDEX_FRLG[pokemon] = {};
			CUSTOMSETDEX_FRLG[pokemon][moveset] = customsets[pokemon][moveset];
			if (!CUSTOMSETDEX_FRLGDE[pokemon]) CUSTOMSETDEX_FRLGDE[pokemon] = {};
			CUSTOMSETDEX_FRLGDE[pokemon][moveset] = customsets[pokemon][moveset];
			if (!CUSTOMSETDEX_FRLGES[pokemon]) CUSTOMSETDEX_FRLGES[pokemon] = {};
			CUSTOMSETDEX_FRLGES[pokemon][moveset] = customsets[pokemon][moveset];
			if (!CUSTOMSETDEX_FRLGJA[pokemon]) CUSTOMSETDEX_FRLGJA[pokemon] = {};
			CUSTOMSETDEX_FRLGJA[pokemon][moveset] = customsets[pokemon][moveset];
