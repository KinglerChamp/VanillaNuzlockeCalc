...
var LE_PATCH = {
    ...
    'Voltorb-Hisui': { abilities: { 0: 'Grassy Surge' } },
    Teddiursa: { abilities: { 0: 'Guts' } },
    Houndour: { abilities: { 0: 'Unnerve' } },
    Phanpy: { abilities: { 0: 'Sturdy' } },
    Poochyena: { abilities: { 0: 'Intimidate' } },
    ...
    Tadbulb: { abilities: { 0: 'Electromorphosis' } },
    Flittle: { abilities: { 0: 'Opportunist' } },
    ...
    Seel: { types: ['Water', 'Ice'] },
    Horsea: { types: ['Water', 'Dragon'] },
    Chikorita: { types: ['Grass', 'Fairy'] },
    Sunkern: { types: ['Grass', 'Fire'] },
    Yanma: { types: ['Bug', 'Dragon'] },
    Larvitar: { types: ['Rock', 'Dark'] },
    Mudkip: { types: ['Water', 'Ground'] },
    Swablu: { types: ['Dragon', 'Fairy'] },
    Turtwig: { types: ['Grass', 'Ground'] },
    ...
    Clobbopus: { types: ['Fighting', 'Water'] },
    ...
    Togepi: { otherFormes: ['Togepi-Mega'] },
    Tyrogue: { otherFormes: ['Tyrogue-Mega-L', 'Tyrogue-Mega-C', 'Tyrogue-Mega-T'] },
    Elekid: { otherFormes: ['Elekid-Mega'] },
    Magby: { otherFormes: ['Magby-Mega'] },
    Smoochum: { otherFormes: ['Smoochum-Mega'] },
    Azurill: { otherFormes: ['Azurill-Mega'] },
    Wynaut: { otherFormes: ['Wynaut-Mega'] },
    Budew: { otherFormes: ['Budew-Mega'] },
    Chingling: { otherFormes: ['Chingling-Mega'] },
    ...
    Exeggcute: { otherFormes: ['Exeggcute-Dragon'] },
    Koffing: { otherFormes: ['Koffing-Fairy'] },
...
var Specie = (function () {
    function Specie(name, data) {
        ...
        baseStats.spa = data.bs.sa; //: data.bs.sl;
        baseStats.spd = data.bs.sd; //: data.bs.sl;
